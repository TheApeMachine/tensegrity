...
class EvalRunner:
    ...
    def __init__(self, model_name: str = "meta-llama/Llama-3.2-1B-Instruct",
                 mode: str = "offline", lam: float = 1.0, seed: int = 42):
    ...
    def evaluate_task(self, task_name: str, max_samples: Optional[int] = None,
    ...
    def sweep_lambda(self, tasks=None, lambdas=None, max_samples_per_task=None,
                     verbose=True) -> List[BenchmarkResult]:
        if lambdas is None:
